...
public class FO_combinationalPAY_Discprice_TestcaseYW extends TestBaseYasasiiWeb{
	...
	public void combinePay(String MRNO , String PROVIDER ,String ADJAMOUNT , String CARDAMOUNT , String CARDNO , String APPROVENO , String AUTHPERSON , String REMARK1, String REMARK2) throws InterruptedException, IOException {
		
		Thread.sleep(8000); 
		
		FO_combinationalPAY_DiscRaise_YasassiWeb  com = new FO_combinationalPAY_DiscRaise_YasassiWeb (driver);
		com.combpay(MRNO, PROVIDER, ADJAMOUNT, CARDAMOUNT, CARDNO, APPROVENO, AUTHPERSON, REMARK1, REMARK2);
