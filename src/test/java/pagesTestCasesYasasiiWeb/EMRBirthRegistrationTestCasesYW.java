...
public void Babydischarge(String Name,String AadharNumber,String MRNo, String Provider , String MRNo1, String ADTprovider,String nurseUser, String password , String depUser , String RADuser , String meduser, String AdminUser , String AdminPassword,String DOCuser , String DOCpassword) throws InterruptedException, IOException {
		...
		Schedule1.dischargeRecommendationBaby(MRNo1, nurseUser, password, depUser, RADuser, meduser, AdminUser, AdminPassword);
		Schedule1.dischargeApprovalBaby(MRNo1, nurseUser, password, depUser, RADuser, meduser, AdminUser, AdminPassword);
		Schedule1.LaboratoryClearanceBaby(MRNo1, nurseUser, password, depUser, RADuser, meduser, AdminUser, AdminPassword);
		Schedule1.radiologyClearanceBaby(MRNo1, nurseUser, password, depUser, RADuser, meduser, AdminUser, AdminPassword);
		Schedule1.medicalClearanceBaby(MRNo1, nurseUser, password, depUser, RADuser, meduser, AdminUser, AdminPassword);
		Schedule1.pharmacyClearanceBaby(MRNo1, nurseUser, password, depUser, RADuser, meduser, AdminUser, AdminPassword);
		Schedule1.ADTapproval(MRNo1, nurseUser, password, depUser, RADuser, meduser, AdminUser, AdminPassword);
		Schedule1.financialClearance(MRNo1, nurseUser, password, depUser, RADuser, meduser, AdminUser, AdminPassword);
		Schedule1.physicalDischarge(MRNo1, nurseUser, password, depUser, RADuser, meduser, AdminUser, AdminPassword ,DOCuser , DOCpassword);
}
