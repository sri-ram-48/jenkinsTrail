...
public class FO_ServiceBilling_TestCaseYW extends TestBaseYasasiiWeb {
	...
	public void billing(String MRNO, String CHEIFCOMPLAINT , String SERVICE,  String CARDNO , String APPROVENO) throws InterruptedException, IOException {
		Thread.sleep(8000); 
		
		FO_ServiceBilling_YasassiWeb bill = new FO_ServiceBilling_YasassiWeb(driver);
		bill.cpoeService(MRNO, CHEIFCOMPLAINT, SERVICE);
		bill.serviceBilling(MRNO, CARDNO, APPROVENO);
