...
public class EMRDietNoteTestCasesYW extends TestBaseYasasiiWeb{
	...
	public void OPEMR(String firstname,String gender,String age,String encounter,String MRNo) throws InterruptedException, IOException {
		EMRDietNoteYasasiiWeb OP = new EMRDietNoteYasasiiWeb(driver) ;
		OP.Diet(firstname,firstname, gender, age,MRNo);
	}
