...
public class EMR_notesAuthorizationOfSeniorByJrDrTestCaseYW extends TestBaseYasasiiWeb {
	...
	public void EMRscreen(String firstname ,String gender,String age,String encounter,String MRNo) throws InterruptedException, IOException {
		EMR_notesAuthorizationOfSeniorByJrDrYW doctorAuth = new EMR_notesAuthorizationOfSeniorByJrDrYW (driver);
		doctorAuth.authorization(firstname ,gender,age,encounter,MRNo);
