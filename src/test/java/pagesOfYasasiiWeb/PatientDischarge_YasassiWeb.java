...
public class PatientDischarge_YasassiWeb  extends PageFactoryInitYasasiiWeb{
	...
	public void dischargeRecommendation(String MRNO , String nurseUser , String  Password) throws InterruptedException {
	...
	public void dischargeApproval(String MRNO , String nurseUser , String  Password , String depUser  ) throws InterruptedException, AWTException {
...
public void laboratoryClearance(String MRNO , String  Password , String depUser , String RADuser ) throws InterruptedException {
	...
	Thread.sleep(1000);
	driver.findElement(By.xpath("//li[normalize-space()='David(dep01)']")).click();
	Thread.sleep(1000);
	verifyPassword.click();
	verifyPassword.sendKeys(Password);
	Thread.sleep(1000);
...
public void radiologyClearance(String MRNO ,  String RADuser , String  Password , String meduser ) throws InterruptedException {
	...
	Thread.sleep(1000);
	driver.findElement(By.xpath("//li[normalize-space()='Susan(rad01)']")).click();
	Thread.sleep(1000);
	verifyPassword.click();
	verifyPassword.sendKeys(Password);
	Thread.sleep(1000);
...
public void medicalClearance(String MRNO  , String  Password , String meduser , String nurseUser ) throws InterruptedException {
	...
	Thread.sleep(1000);
	driver.findElement(By.xpath("//li[normalize-space()='George(Med01)']")).click();
	Thread.sleep(1000);
	verifyPassword.click();
	verifyPassword.sendKeys(Password);
	Thread.sleep(1000);
...
public void PharmacyClearance(String MRNO, String nurseUser,String Password , String AdminUser , String AdminPassword) throws InterruptedException {
...
public void ADTAppoval(String MRNO , String nurseUser,String Password ) throws InterruptedException {
	Thread.sleep(1000);
	FOSearchField.click();
	Thread.sleep(1000);
	Thread.sleep(1000);
...
public void financialClearance(String MRNO , String nurseUser,String Password) throws InterruptedException {
...
public void physicalDischarge( String MRNO , String nurseUser,String Password) throws InterruptedException {
	...
	SearchIcon.click();
	Thread.sleep(1000);
	driver.findElement(By.xpath("//label[normalize-space()='Rohit Sharma']")).click();
