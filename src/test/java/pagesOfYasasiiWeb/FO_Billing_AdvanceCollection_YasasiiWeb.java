...
public class FO_Billing_AdvanceCollection_YasasiiWeb extends PageFactoryInitYasasiiWeb{
	...
	@FindBy(xpath = "//a[contains(@title,'approve bill cancel')]//span[contains(text(),'Cancellation/Refund')]")
	public WebElement refundreq;
	
	@FindBy(xpath = "//span[normalize-space()='Advance Refund']")
	public WebElement advancerefund;
	
	@FindBy(xpath = "/html[1]/body[1]/app-root[1]/app-layout[1]/main[1]/lib-request-approval[1]/div[1]/form[1]/tabset[1]/div[1]/div[1]/tab[3]/table[1]/tbody[1]/tr[1]/td[1]/span[1]/ki-checkbox-control[1]/label[1]/label[1]/span[1]")
...
/////////////Advance refunding	
	public void refund(String authorisername,String remarks) throws InterruptedException
	{
		...
		Thread.sleep(800);
		driver.findElement(By.xpath("//*[contains(text(),'" + authorisername + "')]")).click();
		Thread.sleep(800);
	...
	public void requestaccept() throws InterruptedException
	{
		Thread.sleep(1000);
		emr.click();
		Thread.sleep(800);
