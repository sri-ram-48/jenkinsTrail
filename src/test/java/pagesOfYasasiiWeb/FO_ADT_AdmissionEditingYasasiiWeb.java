...
public class FO_ADT_AdmissionEditingYasasiiWeb extends PageFactoryInitYasasiiWeb{
	...
	@FindBy(xpath = "//*[text()[contains(.,' Accident-Type')]]")
	...
	@FindBy(xpath = "/html[1]/body[1]/app-root[1]/app-layout[1]/main[1]/app-fo-landing[1]/div[2]/app-patient-view[1]/form[1]/div[2]/app-adt[1]/div[1]/div[1]/div[4]/div[1]/form[1]/div[2]/div[1]/app-adt-beddetails[1]/form[1]/div[1]/div[3]/ul[1]/app-list-item[5]/li[1]")
...
Thread.sleep(1000);
	...
	public void edit(String remarks) throws InterruptedException
	{
...
/////////////////////New Tranfer
		...
		BedNo.click();
		Thread.sleep(500);
		driver.findElement(By.xpath("/html[1]/body[1]/app-root[1]/app-layout[1]/main[1]/app-fo-landing[1]/div[2]/app-patient-view[1]/form[1]/div[2]/app-adt[1]/div[1]/div[5]/form[1]/div[1]/div[2]/div[2]/div[1]/app-adt-beddetails[1]/form[1]/div[1]/div[3]/ul[1]/app-list-item[6]/li[1]")).click();
...
///////////////Hold		
		...
		BedNo.click();
		 Thread.sleep(500);
		driver.findElement(By.xpath("/html[1]/body[1]/app-root[1]/app-layout[1]/main[1]/app-fo-landing[1]/div[2]/app-patient-view[1]/form[1]/div[2]/app-adt[1]/div[1]/div[5]/div[1]/div[2]/form[1]/div[1]/div[1]/app-adt-beddetails[1]/form[1]/div[1]/div[3]/ul[1]/app-list-item[1]/li[1]")).click();
		 Thread.sleep(500);
		driver.findElement(By.xpath("//button[@id='savepatadtbutton']")).click();
//////////////Hold Tranfer	
		Thread.sleep(1000);
...
/////////////Tranfer cancel
		...
		threedots.click();
		 Thread.sleep(500);
		driver.findElement(By.xpath("//div[contains(text(),'Transfer Cancel')]")).click();
		 Thread.sleep(500);
...
/////////////////////New reservation
		...
		newReservation.click();
		 Thread.sleep(500);
		 driver.findElement(By.xpath("//body/app-root[1]/app-layout[1]/main[1]/app-fo-landing[1]/div[2]/app-patient-view[1]/form[1]/div[2]/app-adt[1]/div[1]/div[5]/form[1]/div[1]/div[2]/div[1]/div[1]/ki-select-control[1]/div[1]/input[1]")).click();
		 Thread.sleep(500);	
		 driver.findElement(By.xpath("//li[contains(text(),'Deluxe')]")).click();
			 driver.findElement(By.xpath("//div[@class='col-md-12 ng-star-inserted']//ki-select-control[@class='ng-untouched ng-pristine ng-invalid']//input[1]")).click();
			 Thread.sleep(500);
			 driver.findElement(By.xpath("//li[normalize-space()='Normal']")).click();
			 driver.findElement(By.xpath("//body/app-root[1]/app-layout[1]/main[1]/app-fo-landing[1]/div[2]/app-patient-view[1]/form[1]/div[2]/app-adt[1]/div[1]/div[5]/form[1]/div[1]/div[2]/div[1]/div[3]/ki-calendar[1]/div[1]/input[1]")).click();
			 Thread.sleep(500);
