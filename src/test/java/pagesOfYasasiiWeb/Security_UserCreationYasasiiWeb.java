...
public class Security_UserCreationYasasiiWeb extends PageFactoryInitYasasiiWeb {
	...
	@FindBy(xpath = "//li[normalize-space()='Associate Consultant']")
	...
	@FindBy(xpath = "/html[1]/body[1]/app-root[1]/app-layout[1]/main[1]/app-userregister[1]/div[2]/form[1]/div[1]/div[1]/div[2]/accordion[1]/accordion-group[1]/div[1]/div[2]/div[1]/div[3]/div[1]/div[1]/div[3]/ul[1]/app-list-item[1]/li[1]")
	public WebElement SelectDefault;
	
	@FindBy(xpath = "//input[@id='userprofileid']")
	public WebElement UserProfile;
	
	@FindBy(xpath = "//li[normalize-space()='Admin Doctors']")
	public WebElement SelectUserProfile;
	
	@FindBy(xpath = "//label[normalize-space()='Encounter Creation Allowed']//span[@class='checkmark']")
	...
	@FindBy(xpath = "/html[1]/body[1]/app-root[1]/app-layout[1]/main[1]/app-userregister[1]/div[1]/lib-searchbarlist[1]/div[1]/div[3]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]")
	public WebElement clickonname;
	
	@FindBy(xpath = "//body/app-root[1]/app-layout[1]/main[1]/app-userregister[1]/div[1]/lib-searchbarlist[1]/div[1]/div[3]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/label[1]/label[1]/i[1]")
	...
	@FindBy(xpath = "//body/modal-container[1]/div[1]/div[1]/div[2]/app-designation-master[1]/div[1]/lib-searchbarlist[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/label[1]/i[1]")
	public WebElement edit;
	
	@FindBy(xpath = "//ki-checkbox[@controlname='isvalid']//label//label[contains(@class,'check-container')][normalize-space()='Valid']")
...
public void create(String  firstname, String userid, String passwrd,String Phone,String Dept,String desig,String email,String Site) throws InterruptedException{
///////////Create a user	
		Thread.sleep(3000);
		Menutoggle.click();
		Thread.sleep(1000);
...
/////////Add user credentials		
		...
		public void designationcreation(String designation) throws InterruptedException
		{
...
///////////////////Designation delete
			 ...
			 Plusicon.click();
				...
				Thread.sleep(800);
				 driver.findElement(By.xpath("//*[contains(text(),'" + designation + "')]")).click();
				 Thread.sleep(800);
				 driver.findElement(By.xpath("//div[@class='result-card single-layer in-valid ng-star-inserted']//i[@class='ki ki-trash']")).click();
				 Thread.sleep(800);
