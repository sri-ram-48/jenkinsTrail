...
public class FO_combinationalPAY_DiscRaise_YasassiWeb extends PageFactoryInitYasasiiWeb {
	...
	@FindBy(xpath = "/html[1]/body[1]/app-root[1]/app-layout[1]/main[1]/app-fo-landing[1]/div[2]/app-patient-view[1]/form[1]/div[2]/app-billing-overview[1]/div[1]/div[2]/app-encounter-billing[1]/tabset[1]/div[1]/tab[1]/div[1]/div[1]/app-billing-card[1]/div[1]/div[1]/div[1]/p[1]")
	...
	public void combpay(String MRNO , String PROVIDER ,String ADJAMOUNT , String CARDAMOUNT , String CARDNO , String APPROVENO , String AUTHPERSON , String REMARK1, String REMARK2) throws InterruptedException {
...
//	boolean  compare = (NetAmount >= adjAmount) ;
	...
	Assert.assertTrue(compare);
		...
		if(percentage <= 50)
		{
			...
			provider.click();
			Thread.sleep(1000);
			driver.findElement(By.xpath("//li[normalize-space()='Union']")).click();
			Amount.click();
			Thread.sleep(1000);
