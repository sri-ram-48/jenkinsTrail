...
public class EMR_DietitianTemplateTestCaseYW extends PageFactoryInitYasasiiWeb{
	...
	@FindBy(xpath = "//label[@class='icon nonmd']")
	...
	@FindBy(xpath = "//div[@id='cdk-drop-list-0']//div[3]//span[2]//label[1]//i[1]")
	public WebElement edit;
	
	@FindBy(xpath = "/html[1]/body[1]/app-root[1]/app-layout[1]/main[1]/app-rules-setup[1]/div[2]/div[2]/div[4]/div[3]/table[1]/tbody[1]/tr[3]/td[3]/i[1]")
	public WebElement deleteIcd;
	
	@FindBy(xpath = "//button[@id='save']")
	public WebElement update;
	
	@FindBy(xpath = "//div[@id='cdk-drop-list-0']//div[3]//span[2]//label[2]//i[1]")
